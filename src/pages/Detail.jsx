    ...
    <Layout>
      ...
      <div className="flex mb-4 flex-col lg:flex-row">
        <div className="basis-8/12">
          <div className="my-3">
            ...
            <p>{venues.description ? venues.description : "No Description"}</p>
          </div>
        </div>
            ...
            <table className="table-fixed w-full my-3">
              ...
              <tbody className="text-center">
                {operational.map((item, index) => (
                  <tr className="border capitalize" key={index}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-4 my-2">
            {loading
              ...
              : facilities.map((item, index) => (
                  <div key={index}>
                    <IconCard icon={item.icon_name} name={item.name} />
                  </div>
                ))}
          </div>
        </div>
      ...
      <div className="w-full my-5">
        <div className="my-3 space-y-5">
          ...
          <DaySlots selectedDay={selectedDay} setSelectedDay={setSelectedDay} />
