      ...
      <form>
        <div className="flex flex-wrap mx-3 mb-6">
          ...
          {url !== `${window.location.origin}/owner/edit/${venueId}` ? (
            <div className="mb-5 w-full px-3 lg:px-10">
              <h6 className="font-bold my-3">
                Category (<strong className="text-amber-500">*</strong>)
              </h6>
              <div className="">
                <RadioCategory
          ...
          {url !== `${window.location.origin}/owner/edit/${venueId}` && (
            <p className="w-full px-3 lg:px-10">
              (<strong className="text-amber-500">*</strong>) Please make sure
              you fill all the required fields correctly.
            </p>
          )}
          {url === `${window.location.origin}/owner/edit/${venueId}` && (
            <p className="w-full px-3 lg:px-10">
              (<strong className="text-teal-500">*</strong>) If you change the
              image, please click the upload button to upload the new image.
            </p>
          )}
